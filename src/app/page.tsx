        ...
        <div className='p-0 m-0'>
            ...
            <div className="bg-yellow-400 text-yellow-800 p-3 w-full flex justify-center items-center">
                <div className="flex items-center gap-2 max-w-4xl">
                    ...
                    <p className="font-medium">We hebben wat problemeen met iritanten mensen, daarom sturen we je een email die je moet bevestigen om toegang te krijgen tot het forum.</p>
                </div>
            </div>
            {/* AI CODE END */}
